...
/**
 * 
 * High-level representation of an {@link android.nfc.NdefMessage}.
 * 
...
public class Message extends ArrayList<Record> {
    ...
    /**
     * Parse NDEF message bytes into a high-level {@link org.ndeftools.Message} representation.
     * 
     * @param payload record to parse
	 * @return corresponding {@link org.ndeftools.Message} consisting of one or more {@link Record}s.
     * @throws android.nfc.FormatException if known record type cannot be parsed
	 */
	...
	/**
	 * {@link android.nfc.NdefMessage} constructor.
	 * 
	 * @param ndefMessage
	 * @throws android.nfc.FormatException if known record type cannot be parsed
	 */
	...
	/**
	 * Convert record to its byte-based {@link android.nfc.NdefMessage} representation. At least one record needs to be present.
	 * 
	 * @return record in {@link android.nfc.NdefMessage} form.
	...
	/**
	 * {@link android.content.Intent} constructor. Extracts {@link android.nfc.NdefMessage} using key {@link android.nfc.NfcAdapter#EXTRA_NDEF_MESSAGES}.
	 * 
	...
	/**
	 * {@link android.os.Parcelable} array constructor. If multiple messages, records are added in natural order.
	 * 
	 * @param messages {@link android.nfc.NdefMessage}s in {@link android.os.Parcelable} array.
	 * @throws android.nfc.FormatException if known record type cannot be parsed
	 */
