...
/**
 * 
 * High-level representation of a {@link android.nfc.NdefRecord}
 * 
...
public abstract class Record {
    ...
    /**
     * Parse a byte-based {@link android.nfc.NdefRecord} into a high-level {@link org.ndeftools.Record}.
     * 
     * @param ndefRecord record to parse
     * @return corresponding {@link org.ndeftools.Record} subclass - {@link UnsupportedRecord} is not known.
	...
	/**
     * Parse a well-known byte-based {@link android.nfc.NdefRecord} into a well-known high-level {@link org.ndeftools.Record}.
     * 
     * @param ndefRecord record to parse
     * @return corresponding {@link org.ndeftools.Record} subclass - or null if not known
     * @throws android.nfc.FormatException if known record type cannot be parsed
     */
	...
	/**
	 * Convert record to its byte-based {@link android.nfc.NdefRecord} representation.
	 * 
	 * @return record in {@link android.nfc.NdefRecord} form.
	 */
	 ...
	 * 
	 * @return record in byte form as it was an {@link android.nfc.NdefMessage} with a single record.
	 */
	@SuppressLint("NewApi")
